...
Searched for any indication the TOR browser was used to establish a connection using any of the known TOR ports. At `2025-11-19T00:32:45.2797266Z`, user "zgirrens" on the "threat-hunt-lab" device successfully established a connection to the remote IP address `144.6.150.213` on port `9001`. The connection was initiated by the process `tor.exe`, located in the folder `c:\users\zgirrens\desktop\tor browser\browser\torbrowser\tor\tor.exe
...
- **Event:** A network connection to IP `144.6.150.213` on port `9001` by user "zgirrens" was established using `tor.exe`, confirming TOR browser network activity.
